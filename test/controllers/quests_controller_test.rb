...
class QuestsControllerTest < ActionController::TestCase
  ...
  test "should create quest" do
    assert_difference('Quest.count') do
      post :create, quest: { completed_text: @quest.completed_text, description: @quest.description, status: @quest.status, title: @quest.title }
    end
  ...
  test "should update quest" do
    patch :update, id: @quest, quest: { completed_text: @quest.completed_text, description: @quest.description, status: @quest.status, title: @quest.title }
    assert_redirected_to quest_path(assigns(:quest))
  end
